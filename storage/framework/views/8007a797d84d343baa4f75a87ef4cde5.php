        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 bg-surface border border-borderCol p-8 sm:p-10 rounded-3xl shadow-darkCard">
            <div class="space-y-3">
                ...
                <h1 class="text-4xl sm:text-5xl font-extrabold text-textPrimary tracking-tight break-words flex items-baseline gap-3 pt-1">
                    ...
                    <span><?php echo e($folder->name); ?> <span class="text-textMuted font-medium text-2xl">/ Mark Attendance</span></span>
                </h1>
        ...
        >
            <div>
                ...
                <div class="text-xs text-textMuted mt-2">
                    Today: <strong class="text-textPrimary"><?php echo e(\Carbon\Carbon::parse($today)->format('d M Y')); ?></strong>
                </div>
            </div>
                            ...
                            >
                                ...
                                <td class="py-5 px-6 text-center">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <input type="hidden" name="status[<?php echo e($student->id); ?>]" id="status-<?php echo e($student->id); ?>" value="<?php echo e($currentStatus); ?>" class="attendance-input" data-name="<?php echo e($student->name); ?>" data-roll="<?php echo e($student->roll_number); ?>" data-applicable="<?php echo e($isApplicable ? '1' : '0'); ?>">
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<script>
    ...
    function saveSingleStudent(studentId) {
        ...
        form.method = 'POST';
        form.action = "<?php echo e(route('admin.attendance.submit', $folder->id)); ?>";
