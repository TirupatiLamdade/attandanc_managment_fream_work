...
<head>
    <meta charset="UTF-8">
    <title>Subject Attendance Report - <?php echo e($subject->name); ?></title>
    <style>
...
<div class="report-title-box">
    ...
    <div class="folder-highlight">Subject: <?php echo e($subject->name); ?></div>
</div>
...
<div class="report-info">
    <table>
        ...
        <?php if($pdfType === 'daily'): ?>
            <tr><td class="label">Attendance Date</td><td><?php echo e($pdfDate ?? '-'); ?></td></tr>
        <?php elseif($pdfType === 'monthly'): ?>
            <tr><td class="label">Selected Month</td><td><?php echo e($pdfMonth ?? '-'); ?></td></tr>
        <?php elseif($pdfType === 'custom'): ?>
            <tr><td class="label">From Date</td><td><?php echo e($pdfStart ?? '-'); ?></td></tr>
            <tr><td class="label">To Date</td><td><?php echo e($pdfEnd ?? '-'); ?></td></tr>
        <?php endif; ?>
    </table>
</div>

<?php if(!$pdfHasAttendance): ?>
...
</html><?php /**PATH C:\laragon\www\Attandance_Fremwork_2026\resources\Views/admin/subjects/pdf.blade.php ENDPATH**/ ?>