...
<div class="max-w-[92rem] mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a
            href="<?php echo e(route('admin.subjects.students', $subject->id)); ?>"
        ...
        >
            ...
            <div class="mt-6 text-blue-400 font-semibold text-sm">
                <?php echo e($subject->students_count ?? $subject->students->count() ?? 0); ?> Students →
            </div>
        </a>

        
        <a
            href="<?php echo e(route('admin.subjects.report', ['id' => $subject->id, 'type' => 'daily'])); ?>"
            class="bg-surface border border-borderCol hover:border-blue-500 rounded-3xl p-8 transition-all duration-300 shadow-darkCard hover:-translate-y-1 flex flex-col justify-between"
        >
            <div>
                <div class="text-4xl mb-4">📊</div>
        ...
        <a
            href="<?php echo e(route('admin.subjects.total', $subject->id)); ?>"
            class="bg-surface border border-borderCol hover:border-blue-500 rounded-3xl p-8 transition-all duration-300 shadow-darkCard hover:-translate-y-1 flex flex-col justify-between"
        >
            <div>
                <div class="text-4xl mb-4">📈</div>
        ...
        <a
            href="<?php echo e(route('admin.subjects.attendance', $subject->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Attandance_Fremwork_2026\resources\Views/admin/subjects/show.blade.php ENDPATH**/ ?>