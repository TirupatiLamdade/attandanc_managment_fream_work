...
<head>
    ...
    <title>Mark Attendance - {{ $folder->name }}</title>
            ...
            <div class="controls">
                ...
                <div class="field">
                    ...
                    <input
                        ...
                        value="{{ $selectedDate }}"
                        max="{{ $today }}"
                        @if($earliestStudentDate)
                            min="{{ $earliestStudentDate }}"
                        @endif
                    >
                    ...
                    <div class="date-note">
                        ...
                        @if($earliestStudentDate)
                            ...
                            <strong>
                                {{ \Carbon\Carbon::parse($earliestStudentDate)->format('d-m-Y') }}
                            </strong>
